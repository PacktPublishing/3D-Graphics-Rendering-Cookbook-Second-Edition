...
int main()
{
...

  {
    ...
    lvk::Holder<lvk::ShaderModuleHandle> comp = loadShaderModule(ctx, "Chapter05/04_InstancedMeshes/src/main.comp");
    ...
    lvk::Holder<lvk::ShaderModuleHandle> vert = loadShaderModule(ctx, "Chapter05/04_InstancedMeshes/src/main.vert");
    lvk::Holder<lvk::ShaderModuleHandle> frag = loadShaderModule(ctx, "Chapter05/04_InstancedMeshes/src/main.frag");
