...
public:
  ...
  : numIndices_(header.indexDataSize / sizeof(uint32_t))
  {
    ...
    vert_ = loadShaderModule(ctx, "Chapter04/07_MeshRenderer/src/main.vert");
    geom_ = loadShaderModule(ctx, "Chapter04/07_MeshRenderer/src/main.geom");
    frag_ = loadShaderModule(ctx, "Chapter04/07_MeshRenderer/src/main.frag");
  ...
  void draw(lvk::ICommandBuffer& buf, const MeshFileHeader& header) const
  {
