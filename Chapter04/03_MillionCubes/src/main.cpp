...
int main()
{
...

  {
    ...
    lvk::Holder<lvk::ShaderModuleHandle> vert = loadShaderModule(ctx, "Chapter04/03_MillionCubes/src/main.vert");
    lvk::Holder<lvk::ShaderModuleHandle> frag = loadShaderModule(ctx, "Chapter04/03_MillionCubes/src/main.frag");
