...
int main()
{
...

  {
    ...
    lvk::Holder<lvk::ShaderModuleHandle> vert = loadShaderModule(ctx, "Chapter04/06_Tessellation/src/main.vert");
    lvk::Holder<lvk::ShaderModuleHandle> tesc = loadShaderModule(ctx, "Chapter04/06_Tessellation/src/main.tesc");
    lvk::Holder<lvk::ShaderModuleHandle> geom = loadShaderModule(ctx, "Chapter04/06_Tessellation/src/main.geom");
    lvk::Holder<lvk::ShaderModuleHandle> tese = loadShaderModule(ctx, "Chapter04/06_Tessellation/src/main.tese");
    lvk::Holder<lvk::ShaderModuleHandle> frag = loadShaderModule(ctx, "Chapter04/06_Tessellation/src/main.frag");
