...
int main()
{
  ...
  lvk::Holder<lvk::ShaderModuleHandle> vert = loadShaderModule(ctx, "Chapter04/02_TracyProfiler/src/main.vert");
  lvk::Holder<lvk::ShaderModuleHandle> frag = loadShaderModule(ctx, "Chapter04/02_TracyProfiler/src/main.frag");
