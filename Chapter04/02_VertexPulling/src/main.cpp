...
int main()
{
...

  {
    ...
    lvk::Holder<lvk::ShaderModuleHandle> vert = loadShaderModule(ctx, "Chapter04/02_VertexPulling/src/main.vert");
    lvk::Holder<lvk::ShaderModuleHandle> geom = loadShaderModule(ctx, "Chapter04/02_VertexPulling/src/main.geom");
    lvk::Holder<lvk::ShaderModuleHandle> frag = loadShaderModule(ctx, "Chapter04/02_VertexPulling/src/main.frag");
